	...
	function html5Upload() {	
		...
		sUploadURL= 'fileUploaderHtml5'; 	//upload URL
	...
	function callFileUploader (){
		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
			sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/fileUploader',				//샘플 URL입니다.
			sCallback : '/asset/se/uploader/callback.html',									//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
